...
import kitty.KittyController;

@RunWith(SpringRunner.class)
@SpringBootTest
public class ApplicationTest02_autowired {

	/*
	 * The @Autowired annotation is interpreted by the Spring and the controller is
	 * injected before the test methods are run. We are using AssertJ (assertThat()
	 * etc.) to express the test assertions.
	 */

	@Autowired
	private KittyController controller;
