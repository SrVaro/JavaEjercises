...
/*
 * Aqui usaremos las propiedades de Spring para objetoc mock
 * Pero tambien se podrian haber empleado directamente las de Mock
 * Para eso hubieramos hecho     @RunWith(MockitoJUnitRunner.class)
 * y hubieramos usado para inyectar    @Mock para crear el objeto Mock y   
 * @InjectMocks para simular los @autowired (como en Spring)
 * Pero nosotros usaremos Spring
 */
