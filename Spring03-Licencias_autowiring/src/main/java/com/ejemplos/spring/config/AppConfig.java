...
// En este caso le indicamos que el contenido se encuentra en el paquete   model
// Aparece en la version 3.1
@ComponentScan("com.ejemplos.spring.model")
// si necesitamos varias rutas, se indicaria de esta forma
//     @ComponentScan({"spring","rutaB"})
//Lo indicado es an�logo a usar en un XML la siguiente linea
