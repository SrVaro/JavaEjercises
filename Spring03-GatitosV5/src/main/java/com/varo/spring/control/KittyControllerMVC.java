...
@RequestMapping("/mvc/kittys")
@Controller("kittyControllerMVC")
public class KittyControllerMVC {

	private static final Logger logger = LoggerFactory.getLogger(KittyControllerMVC.class);
	...
	public String editKitty(HttpServletRequest request, Model model) {
		...
		Kitty kitty = kittyService.get(kittyId).orElseThrow(KittyNotFoundException::new);
